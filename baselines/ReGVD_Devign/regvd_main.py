...
from TextDataset import TextDataset, convert_examples_to_features
...
def main():
    ...
    if args.do_train:
        ...
        train_dataset = TextDataset(tokenizer, args, cwe_label_map, group_label_map, file_type='train',dataset='json')
